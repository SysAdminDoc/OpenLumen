...
- The local release gate in [tools/local_release_gate.py](tools/local_release_gate.py).
...
- The release APK has a signing-key or checksum discrepancy from what
  the local release gate produced.
- The local release gate lets a banned network permission or GMS/Firebase
  dependency through.
...
- [docs/sbom-and-advisories.md](docs/sbom-and-advisories.md) — SBOM
  output, advisory triage, and accepted-exposure register.
